...
createRestaurantHTML = (restaurant) => {
	...
	const image = DBHelper.pictureForRestaurant(
	...
	const average = DBHelper.ratingAverageForRestaurant(restaurant);
	const rating = document.createElement('span');
	rating.className = 'restaurant-rating';
	rating.setAttribute('aria-label', 'Rating: ' + average + ' of 5');
	rating.innerHTML = DBHelper.ratingHtmlForRestaurant(average);
